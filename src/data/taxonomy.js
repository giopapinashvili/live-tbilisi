...
export const CATEGORIES = [
  ...
  },
  {
    ...
    sub: [
      { id: 'grocery',      ka: 'სასურსათო',        osm: ['shop=convenience', 'shop=greengrocer'] },
      { id: 'supermarket',  ka: 'სუპერმარკეტი',     osm: ['shop=supermarket'] },
      { id: 'market',       ka: 'ბაზარი',           osm: ['amenity=marketplace'] },
      ...
      { id: 'construction', ka: 'სამშენებლო',       osm: ['shop=doityourself', 'shop=hardware', 'shop=paint'] },
  ...
  },
  {
    ...
    sub: [
      { id: 'pharmacy',   ka: 'აფთიაქი',        osm: ['amenity=pharmacy', 'healthcare=pharmacy'] },
      ...
      { id: 'lab',        ka: 'ლაბორატორია',    osm: ['healthcare=laboratory'] },
  ...
  },
  {
    ...
    sub: [
      { id: 'repair',     ka: 'შეკეთება',       osm: ['shop=electronics_repair', 'craft=electronics_repair'] },
      { id: 'laundry',    ka: 'სამრეცხაო',      osm: ['shop=laundry', 'shop=dry_cleaning'] },
      { id: 'tailor',     ka: 'სამკერვალო',     osm: ['craft=tailor', 'shop=tailor'] },
      ...
      { id: 'travel',     ka: 'ტურ-სააგენტო',   osm: ['shop=travel_agency'] },
    ],
  },
  {
  ...
  },
  {
    ...
    sub: [
      ...
      { id: 'courses',      ka: 'კურსები',       osm: ['amenity=training'] },
  ...
  },
  {
    ...
    sub: [
      ...
      { id: 'gym',        ka: 'სპორტდარბაზი',   osm: ['leisure=fitness_centre'] },
